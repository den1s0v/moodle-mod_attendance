...
$string['showcreatorintooltip'] = 'Show creator in course page tooltip';
$string['showcreatorintooltip_desc'] = 'When enabled, the attendance instance creator is shown once in the header of the popup tooltip on the course page.';
$string['showsessioncreatorintooltip'] = 'Show session creator in course page tooltip';
$string['showsessioncreatorintooltip_desc'] = 'When enabled, each session line in the popup tooltip shows the teacher who created that session.';
$string['enablestudentgroupfilterintooltip'] = 'Filter tooltip sessions for students in separate groups mode';
$string['enablestudentgroupfilterintooltip_desc'] = 'When enabled, students see only sessions of their own groups in separate groups mode. In visible groups or no groups mode, all groups are shown. If disabled, the same cached tooltip is shown for all users.';
...
$string['randompasswordkind'] = 'Random password kind';
$string['randompasswordkind_desc'] = 'Random password kind: Simple = 4 digits; Complex = long random string.';
...
$string['showcollapsed'] = 'Collapsed (click to open)';
$string['showdefaults'] = 'Show defaults';
$string['showduration'] = 'Show duration';
$string['showextrauserdetails'] = 'Show extra user details';
$string['showpasswordwithqrcode'] = 'Show password of rotating QR code';
$string['showpasswordwithqrcode_desc'] = 'Show password changing with rotating QR code so students can record their status without scanning QR code, rather by entering the password manually via module on the course.';
...
$string['recalculategrades'] = 'Recalculate attendance grades';
$string['recalculategradesconfirm'] = 'Run recalculation';
$string['recalculategradesconfirmtext'] = 'This will recalculate attendance grades for potentially affected users. Continue?';
$string['recalculategradesdone'] = 'Recalculation finished. Updated {$a->activities} attendance activities and {$a->users} user grades.';
$string['recalculategradesnothing'] = 'No potentially affected users were found.';
$string['recalculategradessummary'] = 'Potentially affected set: {$a->activities} attendance activities and {$a->users} users.';
$string['recalculategradessummarydetailed'] = 'Potentially affected set: {$a->activities} attendance activities and {$a->users} users. Era filter: {$a->era}. Fix date: {$a->fixdate}.';
$string['recalculategradespreview'] = 'Preview candidates';
$string['recalculategradesattendanceid'] = 'Attendance ID filter';
$string['recalculategradesera'] = 'Era filter';
$string['recalculategradesera_before'] = 'Before fix date';
$string['recalculategradesera_after'] = 'On/after fix date';
$string['recalculategradesera_all'] = 'All';
$string['recalculategradesfixdate'] = 'Fix date';
$string['recalculategradesepsilon'] = 'Mismatch tolerance (epsilon)';
$string['recalculategradesmode'] = 'Candidate selection mode';
$string['recalculategradesmode_strict'] = 'Strict — only gradebook rows where SQL policy shows a timeslot conflict (parallel sessions with different grades) AND raw grade mismatches summary policy';
$string['recalculategradesmode_fallback'] = 'Fallback — any raw grade mismatch vs summary policy (no conflict requirement; use preview carefully)';
$string['recalculategradesmode_seeded'] = 'Explicit list — one attendance ID and user ID per line (comma, tab, or semicolon separated)';
$string['recalculategradesallinstances'] = 'All instances';
$string['recalculategradessummarydetailed2'] = 'Scope: {$a->activities} attendance activities, {$a->users} users. Era: {$a->era}. Fix date: {$a->fixdate}. Mode: {$a->mode}. Epsilon: {$a->eps}. Attendance filter: {$a->attendanceid}.';
$string['recalculategradesseedhelp'] = 'For explicit list mode: lines like "123,456" (attendance instance id, user id). Other modes ignore this box.';
$string['recalculategradesseedempty'] = 'Explicit list mode is selected but the list is empty or has no valid lines.';
$string['recalculategradesdiag_title'] = 'Diagnostic counts (why the candidate list may be empty):';
$string['recalculategradesdiag_eligible'] = 'Gradebook-eligible rows (attendance item, raw set, not overridden/excluded/locked, era filter): {$a}';
$string['recalculategradesdiag_withpolicy'] = '…with at least one taken session in policy SQL (join to policy aggregate): {$a}';
$string['recalculategradesdiag_sqlmismatch'] = '…with SQL policy mismatch vs raw (epsilon): {$a}';
$string['recalculategradesdiag_sqlmismatch_conflict'] = '…of those, with timeslot conflict flag (strict mode): {$a}';
$string['recalculategradesdiag_sqlmismatch_noconflict'] = '…SQL mismatch without conflict flag (try Fallback mode): {$a}';
$string['recalculategradesdiag_summaryhint'] = 'Candidates are finally filtered using mod_attendance_summary (same as live grade update), including course start date on sessions.';
$string['recalculategradesrawbefore'] = 'Raw before';
$string['recalculategradesexpectedsql'] = 'Expected (SQL policy)';
$string['recalculategradesexpectedsummary'] = 'Expected (summary / apply)';
$string['recalculategradesdelta'] = 'Delta';
$string['recalculategradeslastwrite'] = 'Last write';
$string['recalculategradesconflict'] = 'Timeslot conflict';
$string['recalculategradesrawafter'] = 'Raw after';
$string['recalculategradesfinalafter'] = 'Final after';
$string['recalculategradesexpectedhelp'] = 'Expected (summary / apply) is what attendance_update_users_grades_by_id will write. Expected (SQL policy) is the analytic query; it should match unless data changed between runs.';
$string['recalculategradescmid'] = 'Course module ID (from URL)';
$string['recalculategradescmid_help'] = 'Optional. Use the id from /mod/attendance/manage.php?id=… — it overrides the attendance instance ID filter.';
$string['recalculategradescmidconflict'] = 'Both attendance ID ({$a->fromfield}) and course module ID ({$a->cmid}) were set; they disagree. Using instance {$a->fromcm} from cmid.';
$string['recalculategradesforensic_title'] = 'Forensic drill-down (single user)';
$string['recalculategradesforensic_needscope'] = 'Forensic mode needs an attendance scope: set course module ID (cmid) or attendance instance ID.';
$string['recalculategradesforensic_noattendance'] = 'Attendance instance not found.';
$string['recalculategradesforensic_nouser'] = 'User not found.';
$string['recalculategradesforensic_step_noitem'] = 'No grade item row for this attendance activity in the gradebook.';
$string['recalculategradesforensic_step_nograde'] = 'No grade_grades row for this user on the attendance grade item.';
$string['recalculategradesforensic_step_flags'] = 'Grade row flags block automatic recalculation: {$a}';
$string['recalculategradesforensic_step_flagsok'] = 'Grade row is not overridden / excluded / locked.';
$string['recalculategradesforensic_step_grades'] = 'Current gradebook values: raw={$a->raw}, final={$a->final}, item grademax={$a->max}.';
$string['recalculategradesforensic_step_lastwrite'] = 'Last grade history timestamp for this item+user: {$a}.';
$string['recalculategradesforensic_step_erapass_before'] = 'Era filter (before fix): PASS (last write is before fix date, or no history).';
$string['recalculategradesforensic_step_erafail_before'] = 'Era filter (before fix): FAIL (last write is on/after fix date — this row would be excluded from before_fix lists).';
$string['recalculategradesforensic_step_erapass_after'] = 'Era filter (after fix): PASS.';
$string['recalculategradesforensic_step_erafail_after'] = 'Era filter (after fix): FAIL (last write before fix date).';
$string['recalculategradesforensic_step_eraall'] = 'Era filter: ALL (no date filter on last write).';
$string['recalculategradesforensic_step_coursestart'] = 'Course start date used by summary SQL: {$a}.';
$string['recalculategradesforensic_step_nopt'] = 'No policy aggregate from attendance_log (no qualifying taken sessions for this user, or maxpoints=0).';
$string['recalculategradesforensic_step_pt'] = 'SQL policy aggregate: points={$a->points}, maxpoints={$a->maxp}, timeslot conflict={$a->conflict}, scaled expected raw (if grademax known)={$a->sqlexp}.';
$string['recalculategradesforensic_step_noactivitygrade'] = 'Attendance activity grade is 0 / not set — summary-based raw cannot be computed for apply.';
$string['recalculategradesforensic_step_summary'] = 'Summary (apply path): taken-sessions % = {$a->pct}%, expected raw = {$a->exp}.';
$string['recalculategradesforensic_step_summarynone'] = 'Summary: user has no taken sessions in the summary query (raw would be cleared on full recalc).';
$string['recalculategradesforensic_step_sqlmatch'] = 'SQL scaled expected matches current raw (within epsilon).';
$string['recalculategradesforensic_step_sqlmismatch'] = 'SQL scaled expected differs from current raw by {$a} (raw − SQL).';
$string['recalculategradesforensic_step_summarymatch'] = 'Summary expected matches current raw (within epsilon).';
$string['recalculategradesforensic_step_summarymismatch'] = 'Summary expected differs from current raw by {$a} (raw − summary).';
$string['recalculategradesforensic_hist_title'] = 'Recent grade_grades_history (latest 25)';
$string['recalculategradesforensic_hist_time'] = 'Time';
$string['recalculategradesforensic_hist_user'] = 'Modified by (id)';
$string['recalculategradesforensic_hist_raw'] = 'Raw';
$string['recalculategradesforensic_hist_final'] = 'Final';
$string['recalculategradesforensic_hist_empty'] = 'No history rows for this item+user.';
$string['recalculategradesforensic_userid'] = 'Forensic user ID';
$string['recalculategradessummarydetailed3'] = 'Scope: {$a->activities} activities, {$a->users} users. Era: {$a->era}. Fix date: {$a->fixdate}. Mode: {$a->mode}. Epsilon: {$a->eps}. Attendance ID field: {$a->attendanceid}. CMID from URL: {$a->cmid}. Instance used in queries: {$a->instance}. Reject lowering: {$a->rejectlower}.';
$string['recalculategrades_reason_title'] = 'Preview by reason (counts)';
$string['recalculategrades_reason_pool'] = 'Rows after SQL selection (mode rules): {$a}';
$string['recalculategrades_reason_droppedsummary'] = 'Dropped because summary matches current raw (within epsilon): {$a}';
$string['recalculategrades_reason_mismatchsummary'] = 'Rows with summary mismatch (candidates before “reject lowering” filter): {$a}';
$string['recalculategrades_reason_raise'] = '…of those, apply would raise raw: {$a}';
$string['recalculategrades_reason_lower'] = '…of those, apply would lower raw: {$a}';
$string['recalculategrades_reason_edge'] = '…of those, edge/nullish comparison: {$a}';
$string['recalculategrades_reason_excludedlower'] = 'Excluded from apply list by “reject lowering” option: {$a}';
$string['recalculategrades_reason_applynote'] = 'The apply button only updates rows still listed in the table below.';
$string['recalculategrades_rejectlower'] = 'Reject lowering on apply';
$string['recalculategrades_rejectlower_yes'] = 'Yes — exclude rows where expected raw is lower than current raw';
$string['recalculategrades_rejectlower_no'] = 'No — include all summary mismatches (use with care)';
$string['recalculategrades_col_currentraw'] = 'Current raw (gradebook now)';
$string['recalculategrades_col_sqldiag'] = 'SQL diagnostic expected raw';
$string['recalculategrades_col_expectedapply'] = 'Expected raw if recalculated (apply/summary)';
$string['recalculategrades_col_potentialrawdelta'] = 'Potential raw change (expected − current)';
$string['recalculategrades_col_lastwrite'] = 'Last grade write';
$string['recalculategrades_col_conflict'] = 'Timeslot conflict (SQL)';
$string['recalculategrades_col_rawafter'] = 'Raw after apply';
$string['recalculategrades_col_finalafter'] = 'Final after apply';
$string['recalculategrades_tablehelp'] = '“Expected raw if recalculated” is what the module will write via the same summary logic as live updates. “SQL diagnostic” is an independent analytic check; if they disagree, use the forensic block for this user.';
$string['recalculategrades_form_intro'] = 'Choose options below, then run a preview or a single-user forensic check. No search runs until you submit the form.';
$string['recalculategradesforensic_submit'] = 'Analyze one user (no site-wide search)';
$string['recalculategradesforensic_status_title'] = 'Status scales for this attendance activity';
$string['recalculategradesforensic_status_set'] = 'Set #';
$string['recalculategradesforensic_status_acronym'] = 'Acronym';
$string['recalculategradesforensic_status_grade'] = 'Grade points';
$string['recalculategradesforensic_status_desc'] = 'Description';
$string['recalculategradesforensic_status_visible'] = 'Active';
$string['recalculategradesforensic_log_title'] = 'Raw attendance_log rows (basis of calculation)';
$string['recalculategradesforensic_log_empty'] = 'No attendance_log rows for this user in this activity.';
$string['recalculategradesforensic_log_session'] = 'Session ID';
$string['recalculategradesforensic_log_slot'] = 'Timeslot';
$string['recalculategradesforensic_log_group'] = 'Group ID';
$string['recalculategradesforensic_log_status'] = 'Status';
$string['recalculategradesforensic_log_grade'] = 'Status grade';
$string['recalculategradesforensic_log_setmax'] = 'Max in set';
$string['recalculategradesforensic_log_autoassign'] = 'Auto-assign high';
$string['recalculategradesforensic_log_lasttaken'] = 'Session marked';
$string['recalculategradesforensic_log_insummary'] = 'In summary';
$string['recalculategradesforensic_log_help'] = '“In summary” = lasttaken set, session on/after course start ({$a}). Rows excluded here are ignored by mod_attendance_summary.';
$string['recalculategradesforensic_slot_title'] = 'Timeslot collapse (how sessions become one logical lesson)';
$string['recalculategradesforensic_slot_empty'] = 'No timeslot rows could be built from logs.';
$string['recalculategradesforensic_slot_sessions'] = 'Sessions in slot';
$string['recalculategradesforensic_slot_sessionids'] = 'Session IDs';
$string['recalculategradesforensic_slot_grades'] = 'Grades in slot (min … max)';
$string['recalculategradesforensic_slot_policy'] = 'Counted grade';
$string['recalculategradesforensic_slot_rule'] = 'Pick rule';
$string['recalculategradesforensic_slot_rule_min'] = 'MIN (all autoassign=0)';
$string['recalculategradesforensic_slot_rule_max'] = 'MAX (mixed or all autoassign=1)';
$string['recalculategradesforensic_slot_total'] = 'Included slots total: {$a->points} / {$a->max} = {$a->pct}% (this drives summary raw before grademax scaling).';
$string['recalculategradesforensic_hist_source'] = 'Source';
...
$string['enablelimitsessionspergroup'] = 'Allow group session limit';
$string['enablelimitsessionspergroup_desc'] = 'If enabled, allows setting a limit on the number of sessions per group at the activity level.';
$string['limitsessionspergroup'] = 'Limit sessions per group';
$string['limitsessionspergroup_help'] = 'Set the maximum number of sessions that can be created for each group. Select "No limit" to allow unlimited sessions, or "Maximum one session per group" to restrict each group to a single session.';
$string['nolimit'] = 'No limit';
$string['maxonesessionpergroup'] = 'Maximum one session per group';
$string['hassessions'] = 'has sessions';
$string['groupswithsessionsinfo'] = 'Groups with existing sessions: {$a}';
$string['limitsessionspergroupexceeded'] = 'Cannot create sessions: the following groups already have the maximum number of sessions allowed: {$a}';
