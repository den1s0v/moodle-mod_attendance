...
$string['recalculategradesforensic_title'] = 'Step-by-step breakdown (single user)';
$string['recalculategradesforensic_needscope'] = 'To show the step-by-step breakdown, set a scope: course module ID (cmid) from the URL or the attendance instance ID.';
...
$string['recalculategradesforensic_userid'] = 'User ID (for step-by-step breakdown)';
...
$string['recalculategrades_tablehelp'] = '“Expected raw if recalculated” is what the module will write via the same summary logic as live updates. “SQL diagnostic” is an independent analytic check; if they disagree, run the step-by-step breakdown for that user (user ID field above).';
