...
$string['recalculategradesforensic_title'] = 'Форензика (один пользователь)';
$string['recalculategradesforensic_needscope'] = 'Для форензики нужен охват: укажите cmid из URL или ID экземпляра посещаемости.';
...
$string['recalculategradesforensic_userid'] = 'ID пользователя для форензики';
...
$string['recalculategradesforensic_status_title'] = 'Шкала статусов этой активности';
$string['recalculategradesforensic_status_set'] = 'Набор №';
$string['recalculategradesforensic_status_acronym'] = 'Кратко';
$string['recalculategradesforensic_status_grade'] = 'Балл статуса';
$string['recalculategradesforensic_status_desc'] = 'Описание';
$string['recalculategradesforensic_status_visible'] = 'Активен';
$string['recalculategradesforensic_log_title'] = 'Строки attendance_log (основание расчёта)';
$string['recalculategradesforensic_log_empty'] = 'Нет записей attendance_log для этого пользователя в этой активности.';
$string['recalculategradesforensic_log_session'] = 'ID сессии';
$string['recalculategradesforensic_log_slot'] = 'Тайм-слот';
$string['recalculategradesforensic_log_group'] = 'ID группы';
$string['recalculategradesforensic_log_status'] = 'Статус';
$string['recalculategradesforensic_log_grade'] = 'Балл статуса';
$string['recalculategradesforensic_log_setmax'] = 'Макс. в наборе';
$string['recalculategradesforensic_log_autoassign'] = 'Авто max';
$string['recalculategradesforensic_log_lasttaken'] = 'Отмечено';
$string['recalculategradesforensic_log_insummary'] = 'В summary';
$string['recalculategradesforensic_log_help'] = '«В summary» = lasttaken задан, sessdate ≥ начала курса ({$a}). Исключённые строки не попадают в mod_attendance_summary.';
$string['recalculategradesforensic_slot_title'] = 'Схлопывание по тайм-слоту (как из сессий получается одно занятие)';
$string['recalculategradesforensic_slot_empty'] = 'Не удалось построить тайм-слоты из логов.';
$string['recalculategradesforensic_slot_sessions'] = 'Сессий в слоте';
$string['recalculategradesforensic_slot_sessionids'] = 'ID сессий';
$string['recalculategradesforensic_slot_grades'] = 'Баллы в слоте (мин … макс)';
$string['recalculategradesforensic_slot_policy'] = 'Учтённый балл';
$string['recalculategradesforensic_slot_rule'] = 'Правило выбора';
$string['recalculategradesforensic_slot_rule_min'] = 'MIN (все autoassign=0)';
$string['recalculategradesforensic_slot_rule_max'] = 'MAX (смешанно или все autoassign=1)';
$string['recalculategradesforensic_slot_total'] = 'Итого по включённым слотам: {$a->points} / {$a->max} = {$a->pct}% (от этого считается raw до масштаба grademax).';
$string['recalculategradesforensic_hist_source'] = 'Источник';
